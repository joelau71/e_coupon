<x-user.layouts.app>
    ...
    <x-user.atoms.container>
        <form action="{{ route('user.post.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <x-user.organisms.text title="Slug" field="slug" required="true" />

            <x-user.organisms.text title="Title" field="title" required="true" />

            <x-user.organisms.textarea title="Body" field="body" isRichText required="true"></x-user.organisms.textarea>
